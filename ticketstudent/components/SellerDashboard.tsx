        ...
        {isReadyToAcceptPayments && (
          <>
            <div className="bg-white p-8 rounded-lg">
              ...
              Mettez en vente vos billets et gérez vos annonces
              </p>
        ...
        <div className="p-6">
          ...
          {!stripeConnectId && !accountCreatePending && (
            <div className="text-center py-8">
              ...
              Créez votre compte vendeur pour commencer à recevoir des paiements en toute sécurité
              via Stripe
              </p>
              <button
                onClick={async () => {
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="mt-2 space-y-1">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">
                        {accountStatus.chargesEnabled
                          ? "Peut accepter des paiements"
                          : "Ne peux pas accepter les paiements"}
                      </span>
                    </div>
                    <div className="flex items-center">
                      <svg
                      ...
                      <span className="ml-2">
                        {accountStatus.payoutsEnabled
                          ? "Peut recevoir des versements"
                          : "Ne peux pas recevoir de versements"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {error && (
                <div className="mt-4 bg-red-50 text-red-600 p-3 rounded-lg">
                  Impossible d'accéder au tableau de bord Stripe. Veuillez d'abord remplir toutes les
                  exigences d'abord.
                </div>
              )}
            </div>
          ...
          {accountLinkCreatePending && (
            <div className="text-center py-4 text-gray-600">
              En préparation de la mise en place du compte...
            </div>
          )}
        </div>
      </div>
